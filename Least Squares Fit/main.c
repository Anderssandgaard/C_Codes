...
printf("---------------------------------------------------------------------\n");
printf("Least Squares Fit of data.txt to Function c1*log(x)+c2+c3*x:\n");
printf("---------------------------------------------------------------------\n");
...
Sigma = Least_Square_fit(x,y,dy,number_of_fit_function,fitfunc,c);
