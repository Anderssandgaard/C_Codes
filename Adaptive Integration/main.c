...
////////////////////////////////////////////////////////
	...
	double Q = Adaptive_Integration_Infinity(f_sqrt,a,b,acc,eps,&err);
...
////////////////////////////////////////////////////////
	...
	Q = Adaptive_Integration_Infinity(f_invsqrt,a,b,acc,eps,&err);
...
////////////////////////////////////////////////////////
	...
	Q = Adaptive_Integration_Infinity(f_lninvsqrt,a,b,acc,eps,&err);
...
////////////////////////////////////////////////////////
	...
	Q = Adaptive_Integration_Infinity(f_mix,a,b,acc,eps,&err);
...
////////////////////////////////////////////////////////
	...
	Q = Adaptive_Integration_Infinity(f_exp,a,b,acc,eps,&err);
...
////////////////////////////////////////////////////////
	...
	Q = Adaptive_Integration_Infinity(f_fancy,a,b,acc,eps,&err);
